...
public class RainSpawner : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        water = FindAnyObjectByType<ModernWater2D>();
    }
    ...
    private void RainfallCountdown()
    {
        ...
        if(rainfallTimer <= 0)
        {
            ...
            isRaining = false;
            water.settings._simulationSettings.enableRain.value = false;
        }
    }
    ...
    private void SpawnRain()
    {
        ...
        water.settings._simulationSettings.enableRain.value = true;
